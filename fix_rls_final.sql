...
-- Este script resolve problemas de recursão infinita nas políticas RLS do Supabase
-- Execute-o no SQL Editor do Supabase se estiver enfrentando erros de timeout ou recursão
...
-- 4. Remover políticas problemáticas (garantia extra)
